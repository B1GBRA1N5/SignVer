...
genuine_image_paths = "D:\\VS WorkSpace\\SignatureForgeryDetection\\real"
forged_image_paths = "D:\\VS WorkSpace\\SignatureForgeryDetection\\forged"
...
def makeCSV():
    ...
    for person in range(1,13):
        ...
        with open('D:\\VS WorkSpace\\SignatureForgeryDetection\\Features\\Training/training_'+per+'.csv', 'w') as handle:
        ...
        with open('D:\\VS WorkSpace\\SignatureForgeryDetection\\Features\\Testing/testing_'+per+'.csv', 'w') as handle:
            handle.write('ratio,cent_y,cent_x,eccentricity,solidity,skew_x,skew_y,kurt_x,kurt_y,output\n')
            # Testing set
            for i in range(3, 5):
                source = os.path.join(gpath, per+per+'_00'+str(i)+'.png')
